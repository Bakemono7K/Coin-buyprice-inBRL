...
public class DollarService {
	...
	public Coin getDollar() throws JsonMappingException, JsonProcessingException {
		...
		Double buyPrice = data.findPath("USD").findValue("buy").asDouble();
		String name = data.findPath("USD").findValue("name").toString();
		Coin dol = new Coin(name, buyPrice);
		return dol;
	}
